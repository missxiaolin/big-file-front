<template>
    <div>
        ...
        <div class="verify-bottom">
            ...
            <el-button class="verify-btn" @click.native="getCamera">开始录制</el-button>
        </div>
        ...
        <div class="video" v-show="showVideo">
            ...
            <!-- 关闭按钮 -->
            <el-button class="video-close" @click.native="closeVideo" >×</el-button>
            <el-button
                class="video-save"
                @click.native="saveVideo"
            >{{ isAlreadyRecord ? '结束录制(' + count + 's)' : '开始录制' }}</el-button>
        </div>
